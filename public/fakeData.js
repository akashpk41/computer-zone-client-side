const data = [
  {
    id: 1,
    name: "ASUS B560M Motherboard",
    img: "https://i.ibb.co/rMKJwXB/motherboard.jpg",
    price: 7600,
    available: 100,
    minimumOrder: 40,
    description:
  ...
  {
    id: 2,
    name: "Vengeance RGB RAM",
    img: "https://i.ibb.co/S7hGczz/ram.jpg",
    price: 2000,
    available: 200,
    minimumOrder: 90,
    description:
  ...
  {
    id: 3,
    name: "https://i.ibb.co/nr5yhqH/cpu.jpg",
    img: "Intel Core i7 Processor",
    price: 6600,
    available: 100,
    minimumOrder: 50,
    description:
  ...
  {
    id: 4,
    name: "Fiodio Mechanical Keyboard",
    img: "https://i.ibb.co/2SS4Hkz/keyboard.jpg",
    price: 660,
    available: 350,
    minimumOrder: 150,
    description:
...

  {
    ...
    img: "https://i.ibb.co/6ZkpS96/wirless-mouse.jpg",
    price: 1050,
    available: 500,
    minimumOrder: 200,
    description:
...

  {
    ...
    img: "https://i.ibb.co/sVDdsHw/graphic-card.jpg",
    price: 40500,
    available: 50,
    minimumOrder: 20,
    description:
      "Chipset: NVIDIA GeForce RTX 3080 LHR Boost Clock: 1815 MHz  Output: DisplayPort x 3 (v1.4) / HDMI x 1  ",
  },

  {
    id: 7,
    name: "Seagate 8TB HDDD",
    img: "https://i.ibb.co/wdsqZsM/hard-disk.jpg",
    price: 2300,
    available: 220,
    minimumOrder: 90,
    description:
  ...
  {
    id: 8,
    name: "SAMSUNG 34-Inch Monitor",
    img: " https://i.ibb.co/R6GF1h8/monitor.jpg",
    price: 10900,
    available: 130,
    minimumOrder: 60,
    description:
